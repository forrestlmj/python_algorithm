...
class Solution(object):
    def get_max(self,nums):
        if len(nums) == 1:
            ...
            a = self.get_max(nums[0:int(len(nums)/2)])
            b = self.get_max(nums[int(len(nums)/2):])
...
def test3():
    s = Solution()
    print(s.maxSubArray([1,1,1,-2,3]))#4
    print(s.maxSubArray([1,1,1,-5,3]))#3
